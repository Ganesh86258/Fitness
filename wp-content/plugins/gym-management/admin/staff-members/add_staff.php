        ...
        <div class="panel-body">
			<form name="staff_form" action="" method="post" class="form-horizontal" id="staff_form">	
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="city_name" class="form-control validate[required,custom[onlyLetterSp]]" type="text" maxlength="50"  name="city_name" 
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="phone" class="form-control text-input phone_validation" minlength="10" maxlength="15"  type="text"  name="phone" 
