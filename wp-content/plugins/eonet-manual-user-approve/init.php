<?php
/*
Plugin Name: Eonet Manual User Approve
Plugin URI: https://wordpress.org/plugins/eonet-manual-user-approve/
Description: Allows the admin of the site to approve or deny users manually, after they have registered.
Text Domain: eonet-manual-user-approve
